...
// import React from "react";
// import { useSession, signOut } from "next-auth/react";
// import { Handbag, LayoutDashboard, PlusCircle, Settings, LogOut, ChevronDown, User } from "lucide-react";
// import Logo from "./Logo";
...
//   return (
//     <div className="navbar bg-base-100/90 backdrop-blur-md shadow-lg px-6 md:px-16 lg:px-24 sticky top-0 left-0 right-0 z-50 border-b border-white/5">
//       <div className="navbar-start">
//         {/* Mobile Dropdown */}
//         <div className="dropdown">
//           <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
...
//           <li><Link href="/products" className="hover:text-teal-400 transition-colors">Products</Link></li>
//         </ul>
//       </div>
...
//         {session ? (
//           <div className="dropdown dropdown-end">
//             {/* Modern Dashboard Trigger */}
//             <div tabIndex={0} role="button" className="btn btn-ghost hover:bg-teal-500/10 gap-2 px-4 rounded-full border border-white/10">
//               <div className="avatar">
//                 <div className="w-7 rounded-full ring ring-teal-500 ring-offset-base-100 ring-offset-2">
//                   <img src={session?.user?.image || "https://ui-avatars.com/api/?name=" + session?.user?.name} alt="avatar" />
//                 </div>
//               </div>
//               <span className="hidden md:block font-bold text-sm text-teal-500">Account</span>
//               <ChevronDown size={16} className="text-gray-400" />
//             </div>

//             {/* Modernized Menu Content */}
//             <ul tabIndex={0} className="mt-3 z-[1] p-3 shadow-2xl menu menu-sm dropdown-content bg-base-200 rounded-2xl w-64 border border-white/10 backdrop-blur-xl">
//               <li className="menu-title px-4 py-2 text-xs uppercase tracking-widest text-gray-500">Authenticated as</li>
//               <div className="px-4 py-2 mb-2 bg-teal-500/5 rounded-xl border border-teal-500/10">
//                 <p className="font-bold text-teal-500 truncate">{session?.user?.name}</p>
...
//               <li>
//                 <Link href="/add" className="py-3 flex gap-3 hover:text-teal-500 transition-all group">
//                   <PlusCircle size={18} className="group-hover:scale-110 transition-transform" /> 
//                   <span>Add New Product</span>
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/manage" className="py-3 flex gap-3 hover:text-teal-500 transition-all group">
//                   <LayoutDashboard size={18} className="group-hover:scale-110 transition-transform" /> 
//                   <span>Manage Inventory</span>
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/settings" className="py-3 flex gap-3 hover:text-teal-500 transition-all group">
...
//                 <button 
//                   onClick={() => signOut()} 
//                   className="py-3 text-red-400 hover:bg-red-500/10 flex gap-3 rounded-xl transition-all"
//                 >
//                   <LogOut size={18} /> Logout
//                 </button>
//               </li>
...
//           </div>
//         ) : (
//           <Link href="/login" className="btn btn-teal-500 btn-sm md:btn-md rounded-full px-8 text-white border-none shadow-lg shadow-teal-500/20 hover:scale-105 active:scale-95 transition-all">
//             Login
//           </Link>
//         )}
//       </div>
