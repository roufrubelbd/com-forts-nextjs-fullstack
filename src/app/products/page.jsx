...
// export default async function ProductsPage({ searchParams }) {
//   // FIX: Add "|| {}" to prevent "undefined" errors if the URL has no query strings
//   const filters = (await searchParams) || {}; 
...
//       <h1 className="text-3xl font-bold mb-2 text-teal-600">All Collections</h1>
...
//           <option value="Home Decor">Home Decor</option>
//         </select>
//         <button type="submit" className="btn bg-teal-600 border-none text-white px-8">
//           Filter
//         </button>
//       </form>
...
//         {products.map((product) => (
//           <div key={product._id.toString()} className="bg-base-200 p-4 rounded-lg shadow hover:shadow-md transition">
//             <img 
//               src={product.image} 
//               alt={product.title} 
...
//             <Link 
//               href={`/products/${product._id}`} 
//               className="btn btn-sm btn-outline border-teal-600 text-teal-600 mt-4 w-full"
//             >
//               View Details
//             </Link>
//           </div>
...
//           No products found matching &quot;{search}&quot; in {category}.
//         </div>
//       )}
//     </div>
//   );
